...
Agilni software development snažno promovira praksu \emph{CI}-a. Ona značajno utiče na smanjenje \emph{technical debth}-a. Dosljednja primjena CI-a omogućava razvojnom timu da se korisnicima isporučuju nove verzije u najkraćemo roku po okončanju razvojnog ciklusa razvoja software-a. Kvalitetna pokrivenost testovima, koje CI sistem svakodnevno izvršava \textbf{prije isporuke} software-a krajnjem korisniku, obezbjeđuju minimalnu isporuku verzija koje unose regresije u softverski sistem.\footnote{Verzije koje se najbolje opisuju kolokvijalnim riječnikom sa "Majstor jedno napravio, al' dva pokvario"} 
...
\begin{itemize}
  ...
  \item \emph{Continous integration} bez prakse korištenja SCM-a, testiranja gubi smisao. 
\end{itemize}
